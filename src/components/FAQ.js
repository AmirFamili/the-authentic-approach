        ...
        <section className=" bg-slate-100">
            ...
            <div className="pb-10">
                ...
                <div className="mx-auto p-3 border-b max-sm:mx-6  w-2/3 max-sm:w-11/12">
                    <h4 className=" transition  text-xl p-3 max-sm:text-lg  hover:text-yellow-main focus:text-yellow-main cursor-pointer" onClick={() => setShow1(!show1)}>Can I book sessions outside of business hours?</h4>
                ...
                <div className=" mt-2 mx-auto p-3 max-sm:mx-6 border-b w-2/3 max-sm:w-11/12">
                    <h4 className="transition  text-xl p-3 max-sm:text-lg  hover:text-yellow-main focus:text-yellow-main cursor-pointer" onClick={() => setShow2(!show2)}>How long is a typical session?</h4>
                ...
                <div className="mt-2 mx-auto p-3 max-sm:mx-6 border-b w-2/3 max-sm:w-11/12">
                    <h4 className=" transition  text-xl p-3 max-sm:text-lg  hover:text-yellow-main focus:text-yellow-main cursor-pointer" onClick={() => setShow3(!show3)}>What types of issues can The Authentic Approach help me with?</h4>
                ...
                <div className="mt-2 mx-auto p-3 max-sm:mx-6 border-b w-2/3 max-sm:w-11/12">
                    <h4 className="transition  text-xl p-3 max-sm:text-lg hover:text-yellow-main focus:text-yellow-main cursor-pointer" onClick={() => setShow4(!show4)}>Does the Authentic Approach take my insurance?</h4>
